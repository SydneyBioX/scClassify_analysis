...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar  5 20:20:37 2020
...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun  8 22:38:15 2019
...
def run_scVI(trainname, testname , n ):
    ...
    os.chdir("/dora/nobackup/yuec/scclassify/benchmark/scVI/vary_train")
...
for i in range(0, len(trainlist)):
  ...
  mem_train, time_train, mem_test, time_test = run_scVI(train, "test_2000" , train)
