...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar  5 21:40:04 2020
...
def run_SVMreject( trainname, testname,   n):
    ...
    os.chdir("/dora/nobackup/yuec/scclassify/benchmark/SVMreject/vary_celltype")
...
for i in range(0, len(trainlist)):
  ...
  mem_train, time_train, mem_test, time_test = run_SVMreject(train, "test_5000" , train)
