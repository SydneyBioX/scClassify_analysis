...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar  5 19:50:48 2020
...
def run_moana(trainname, testname, n):
    ...
    os.chdir("/dora/nobackup/yuec/scclassify/benchmark/moanna/vary_test")
...
for i in range(0, len(trainlist)):
  ...
  mem_train, time_train, mem_test, time_test = run_moana( "test_2000" , train ,  name[i])
